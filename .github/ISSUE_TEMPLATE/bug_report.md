---
name: Bug report
about: Report a visual or functional issue with the Material GTK Theme
title: ''
labels: 'BUG'
assignees: ''
...
### Describe the bug
Describe the issue in detail, what happens, when it happens, and how it affects the Material GTK Theme.
Please specify whether it occurs in light, dark, or both variants.

> Example:
> In GTK4 applications, button hover states ignore the accent color from the `Oceanic` variant and use a default system blue instead.

### To Reproduce
Steps to reproduce the behavior:
1. Apply the theme variant (e.g., `Material-BL-MB`)
...
### Expected behavior
Explain how the UI should look or behave according to Material’s design.
...
- **Theme Variant:** (e.g., Material-BL-MB)
...
- **Shell Theme (if any):** (e.g., Material-B, Material-BL-Palenight)
