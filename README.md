...
> A GTK theme based on the colours of [Marko Cerovac's](https://github.com/marko-cerovac) great theme: [Material for Neovim](https://github.com/marko-cerovac/material.nvim), the [VinceLiuice's](https://github.com/vinceliuice) awesome: [Graphite GTK theme](https://github.com/vinceliuice/Graphite-gtk-theme) and the creativity of [Gusbemacbe's](https://github.com/gusbemacbe): [Suru Plus Icon Theme](https://github.com/gusbemacbe/suru-plus).<br />
...
![Material](https://raw.githubusercontent.com/Fausto-Korpsvart/Material-GTK-Themes/master/deepOcean/screenshots/Material-GTK.png)
